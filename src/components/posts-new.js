...
class PostsNew extends Component {
  ...
  _onSubmit(props) {
    ...
    .then(() => {
      //blog post has been created, navigate user to index route.
...
//reduxForm: first is form config, second is mapStateToProps
// third is mapDispatchToProps

export default reduxForm({
  //config object, or the 'letter'
  form:'PostsNewForm', //unique form key
  fields: ['title','categories','content'], //These are the form fields
  validate
